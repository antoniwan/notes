...
- Brain Science pages duplicate sentiment / Flesch / keyword scans; cache signature ignores title and same-length body edits.
- Dual redirect tables invite drift.

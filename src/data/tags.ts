...
const TAG_DESCRIPTIONS: Record<string, string> = {
  consciousness: 'Awareness and mindful presence',
  'personal-growth': 'Continuous self-improvement and development',
  'mental-health': 'Psychological well-being and emotional balance',
  healing: 'Recovery and restoration processes',
  ...
  poems: 'Poems and poetry',
  memoir: 'Lived memory, told as narrative',
  reflection: 'Direct reflective writing',

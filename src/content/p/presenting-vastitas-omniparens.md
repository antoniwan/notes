...
The short form, for daily use, is _Vastitas_. The full form lives in writing, in ceremony, and in my heart.

This name is not for _her_, as _she_ does not need one. You might be inclined to read this and correct me. An it, you are talking about an it. But no, it is a _she_, and I will get to why, and _she_, the totality, was here before the words and will be here after them. This name is for us mere mortals.
...
_Omniparens_ is the word Latin built for exactly what I spent years trying to find or create: she who births all things, the parent of everything. Lucretius uses it for mother Earth in the same line that names her the common grave of all things, _omniparens eadem rerum commune sepulcrum_. Vergil reaches for the same word in the _Aeneid_, _terrae omniparentis alumnum_, a nursling of the all-bearing earth. Birth and grave in one breath, two thousand years before I was looking for it, kinda cool.

There is a reason I could not just use the word we already have. _Universum_ was once the name for the whole. Over the last few centuries, science and other currents of humankind I do not fully understand narrowed _universum_ into _universe_, the _physical_ system cosmology studies, and in that legitimate narrowing we lost the word for the totality. Nobody stole anything, that is the thing, words shrink while you are standing on them and nobody notices until much later. And we cannot take it back now, not from inside its current use, so the only move left is the one Latin always made anyway, which is to shove two surviving words up against each other until they carry what the broken one dropped.
...
So the question, and this is the entire third tier folded into one question, is: what is _my_ Tuesday? What category or categories are not installed in me? What am I unable to formulate or perceive? I cannot answer any of these, and I cannot answer them for the same reason she could not answer hers, and honestly, if I could answer it, it would not have been in that third pile in the first place.

I watched _Disclosure Day_ last night, the Spielberg one, where a meteorologist and a cybersecurity analyst try to prove to the whole world that we are not alone while a government contractor works to stop them. It left me feeling tiny, and I have been trying to figure out why, because the tininess did not come from the aliens or the disclosure.
...
- [Latin](https://en.wikipedia.org/wiki/Latin): the language of _vastitas_ and _omniparens_
- [Etymology](https://en.wikipedia.org/wiki/Etymology), [semantic change](https://en.wikipedia.org/wiki/Semantic_change), and [lexical gap](https://en.wikipedia.org/wiki/Lexical_gap): how word meanings shift over time, including how _universum_ narrowed into _universe_
- [Grammatical gender](https://en.wikipedia.org/wiki/Grammatical_gender): why _vastitas_ is feminine and _universum_ is neuter in Latin

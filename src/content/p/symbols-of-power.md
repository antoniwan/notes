...
<figure class="post-inline-figure">
  <img
    ...
    decoding="async"
  />
  <figcaption>The sword that was broken</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    ...
    alt="Young Link pulling the Master Sword out of its pedestal"
    loading="lazy"
    decoding="async"
  />
  <figcaption>The blade of evil's bane</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    ...
    alt="Master Chief holding the MA5C assault rifle"
    loading="lazy"
    decoding="async"
  />
  <figcaption>Halo's UNSC standard. Master Chief + MA5C = magical fireworks.</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    ...
    alt="Mjölnir as depicted in the God of War games"
    loading="lazy"
    decoding="async"
  />
  <figcaption>Hammer of thunder, as depicted in the God of War games</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    ...
    alt="Guts from Berserk wielding Dragon Slayer"
    loading="lazy"
    decoding="async"
  />
  <figcaption>Guts from Berserk, wielding Dragon Slayer</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    ...
    alt="Vegvisir, an Icelandic magical stave"
    loading="lazy"
    decoding="async"
  />
  <figcaption>The wayfinder rune</figcaption>
</figure>
...
<figure class="post-inline-figure">
  <img
    src="/symbols/lightsaber.avif"
    alt="A lightsaber blade tuned to the soul of its wielder"
    loading="lazy"
    decoding="async"
  />
  <figcaption>A blade tuned to the soul of its wielder</figcaption>
</figure>
...
## A catalog of power symbols

These symbols go beyond ink. They are usable power icons — to focus the mind, call in energy, or remember who the fuck you are.

### Anime and manga

- **Brand of Sacrifice** (_Berserk_) — Survival through pain. Use when you feel cursed, but keep going. You _are_ the resistance.
- **Uchiha Crest** (_Naruto_) — Fire, bloodline, tragic genius. Remember your depth. You see what others don't. Channel emotion into clarity.
- **Alchemist Circle** (_Fullmetal Alchemist_) — Transformation through cost. Draw when something needs to change. Use it in journaling or rituals. Equivalent exchange.
- **Hunter's License** (_Hunter x Hunter_) — Permission to explore the edge. Mastery grants access to deeper quests. You've earned this.
- **Goku's Kanji** (悟) (_Dragon Ball Z_) — Wisdom, growth, power. Wear it when training, learning, or ascending. You are always leveling up.
...
- **Planeteer Rings** (_Captain Planet_) — Elements plus heart. Choose one element to embody in a day. Combine with others in group rituals.
...
- **Bonfire** (_Dark Souls_) — Rest, rebirth in chaos. A grounding ritual. Light a candle to reset.
...
- **Fire Keeper Eyes** (_Dark Souls III_) — Inner darkness, compassion. Seeing what is, not what should be. Use during therapy, shadow work.
- **Vault-Tec Logo** (_Fallout_) — Survival, irony. You are prepared. Humor is a weapon.
...
- **One Ring** (_Lord of the Rings_) — Corruption of power. Ask: what do I desire that might destroy me? Use for ego checks.
- **Light of Eärendil** (_Lord of the Rings_) — Hope in darkness. Keep a "light" object nearby. For when it gets dark again.

### Mythic additions

- **Witcher Medallion** — Magic radar. A reminder to listen to your instincts. Tremors equal truth.
...
- [Berserk](https://www.imdb.com/title/tt0318871/) — anime / manga
- [Naruto](https://www.imdb.com/title/tt0409591/) — anime
- [Fullmetal Alchemist: Brotherhood](https://www.imdb.com/title/tt1355642/) — anime
- [Hunter x Hunter](https://www.imdb.com/title/tt2098220/) — anime
- [Dragon Ball Z](https://www.imdb.com/title/tt0214341/) — anime
- [Yu-Gi-Oh!](https://www.imdb.com/title/tt0243639/) — anime
- [Thundercats](https://www.imdb.com/title/tt0086811/) — cartoon
- [He-Man](https://www.imdb.com/title/tt0085033/) — cartoon
- [Captain Planet](https://www.imdb.com/title/tt0098763/) — cartoon
- [Green Lantern](https://www.imdb.com/title/tt1133985/) — comics / film
- [The Legend of Zelda](https://en.wikipedia.org/wiki/The_Legend_of_Zelda) — video game
- [Dark Souls](https://www.imdb.com/title/tt2010090/) — video game
- [Halo](https://www.imdb.com/title/tt0464037/) — video game
- [God of War](https://www.imdb.com/title/tt5838588/) — video game
- [Fallout](https://www.imdb.com/title/tt0142032/) — video game
- [Lost](https://www.imdb.com/title/tt0411008/) — TV series
- [Avengers: Infinity War](https://www.imdb.com/title/tt4154756/) — film
- [The Lord of the Rings](https://www.imdb.com/title/tt0120737/) — film
- [The Witcher](https://www.imdb.com/title/tt5180504/) — game / series
- [Skyrim](https://www.imdb.com/title/tt1814884/) — video game
- [Assassin's Creed](https://www.imdb.com/title/tt2094766/) — video game / film

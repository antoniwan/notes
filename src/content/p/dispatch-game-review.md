...
If you've read my [Crimson Desert review](/p/my-crimson-desert-review-after-200-hours/), you know the bar: 30+ years across NES through AAA, same scorecard. Dispatch is an **8 out of 10**, *"Great!"*, **4 out of 5**. Not a 9 — the dispatch loop clicks early and stops deepening; after that you're here for the story. AdHoc (Telltale alumni) trades mechanical depth for narrative depth. I respect the trade. The writing pulls harder than the systems.

## What Dispatch Is

Dispatch is narrative-driven: you play Robert Robertson, aka MechaMan, a superhero who moved into the dispatcher's chair. Your team is the Z-Team — ex-supervillains trying, in their chaotic ways, to stay on the right side. You assign them to incidents by stats, watch calls play out, make choices between shifts, and the relationships you build or neglect shape who they become. Invincible meets The Boys with a tactical management layer, and more heart than that pitch suggests.

## The Dispatch Mechanic

Dispatch screen on PC: incident details and Z-Team assignments

The loop lives on the dispatch screen: read an incident, match stats and personality to the call, live with the outcome. About a third of the way in it stops being a puzzle — you read calls the way the writers want you to read them, and the screen becomes a values check. Who are you willing to send into a mess? Who are you protecting from the call that would break them? Once I got that, I stopped optimizing and started deciding who I wanted these people to become. In several areas of the game the dispatch scenarios get additional layers or challenges, I won't go into detailing these to avoid spoilers but let's just say emotions and interpersonal relationships come into play into the dispatching and it's super fun.
